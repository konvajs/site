---
title: HTML5 Canvas 自定义字体——加载 Web 字体与测量文本宽度
sidebar_label: 自定义字体
hide_table_of_contents: true
slug: Custom_Font.html
description: "在 HTML5 Canvas 上使用 Konva 加载自定义 Web 字体。使用 Font Loading API 和缓存重置，修复字体加载前文本宽度测量错误的问题。"
---
...
这里有一点需要注意。为 DOM 元素（例如 `div` 或 `span`）设置字体时，浏览器会在字体加载完成后自动更新这些元素。但是，Canvas 文本并非如此。必须再次绘制 Canvas。
