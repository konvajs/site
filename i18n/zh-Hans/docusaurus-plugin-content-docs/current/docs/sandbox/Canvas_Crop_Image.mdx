---
title: Canvas 图像裁剪——使用 JavaScript 裁剪和提取图像区域
sidebar_label: 裁剪图像
hide_table_of_contents: true
slug: Canvas_Crop_Image.html
description: 学习使用 JavaScript 在 HTML5 Canvas 上裁剪图像。选择区域、调整裁剪区域的大小，然后使用 Konva.js 提取裁剪后的图像。包含交互式示例和源代码。
---

拖动蓝色裁剪矩形以选择所需区域，使用控制柄调整其大小，然后单击按钮提取该区域。

**操作说明：** 拖动裁剪框以移动它。使用角部控制柄调整大小。单击“Crop Image”提取图像。
