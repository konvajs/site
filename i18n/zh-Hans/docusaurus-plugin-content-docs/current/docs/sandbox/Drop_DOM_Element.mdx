---
title: 如何将 DOM 图像拖放到 Canvas
sidebar_label: 拖放 DOM 元素
hide_table_of_contents: true
slug: Drop_DOM_Element.html
description: "使用 HTML5 拖放 API 和 Konva，将外部 DOM 图像拖放到 HTML5 Canvas 舞台上。"
---

此示例演示如何将 Canvas 外部的 DOM 元素放到舞台中。

第一个图像是 DOM 图像。可以使用 [HTML 拖放](https://web.dev/articles/drag-and-drop) 使它可拖动。

要在触摸设备上为 DOM 元素启用拖放，需要执行一些额外步骤。有关详细信息，请阅读[此文](https://mobiforge.com/design-development/touch-friendly-drag-and-drop)。
