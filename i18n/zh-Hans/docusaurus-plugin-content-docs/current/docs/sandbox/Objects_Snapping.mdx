---
title: Canvas 吸附与对齐参考线——拖动时吸附图形
sidebar_label: 吸附与对齐参考线
hide_table_of_contents: true
slug: Objects_Snapping.html
description: "在 Konva 中使用参考线，将可拖动图形吸附到其他对象和舞台边界的边缘与中心。"
---

## 如何使可拖动图形相互吸附

此示例使拖动的图形吸附到舞台和其他图形。每个图形均可在
其左侧、中心、右侧、顶部、中部和底部边缘吸附。

以下外部示例演示网格吸附：

1. [网格吸附文章](https://medium.com/@pierrebleroux/snap-to-grid-with-konvajs-c41eae97c13f)
2. [网格吸附示例](https://codepen.io/pierrebleroux/pen/gGpvxJ)

**操作说明：** 将一个矩形拖到另一个矩形或舞台边缘附近。
蓝色参考线显示当前的吸附位置。
