...
`ng2-konva` 是一个 JavaScript 库，可使用 [Angular](https://angular.io/) 绘制复杂的 Canvas 图形。它为 [Konva 框架](https://konvajs.org/) 提供声明式和响应式绑定。

[GitHub 仓库](https://github.com/konvajs/ng2-konva)

它尝试让 [Angular](https://angular.io/) 与 HTML5 Canvas 库配合使用。其目标是提供与普通 Angular 类似的声明式标记和数据流模型。
...
需要 [Angular](https://angular.io/) 20 或更高版本。
