...
get/set filter brightness. With [Konva.Filters.Brighten](/api/Konva.Filters.html#Brighten) it is a number between -1 and 1  added to every channel: positive values brighten the pixels and negative values darken them.  With [Konva.Filters.Brightness](/api/Konva.Filters.html#Brightness) it is a CSS-like multiplier: 1 is no change, 1.5 is 50% brighter.
...
get/set threshold. With [Konva.Filters.Threshold](/api/Konva.Filters.html#Threshold) it is a value between 0 and 1. With [Konva.Filters.Mask](/api/Konva.Filters.html#Mask) it is the colour distance to the background, 0 to 255, default 10.
