...
get/set kaleidoscope power. Use with [Konva.Filters.Kaleidoscope](/api/Konva.Filters.html) filter.
...
get/set kaleidoscope angle. Use with [Konva.Filters.Kaleidoscope](/api/Konva.Filters.html) filter.
