...
sidebar_label: Konva
slug: /api/Konva.html
description: "Konva namespace reference for Konva.js: properties, methods and configuration for working with Konva on HTML5 Canvas."
sidebar_position: 1
---
...
Configure what mouse buttons can be used for drag and drop. Default value is [0, 1] - left and middle mouse buttons.
