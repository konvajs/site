...
description: "Animation constructor.. Konva.Animation class reference for Konva.js: properties, methods and configuration for working with Animation on HTML5 Canvas."
