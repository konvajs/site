...
slug: Groups.html
description: "Learn how to group multiple shapes together with Konva.Group to move, rotate, and scale them as a single unit."
---
...
For a full list of attributes and methods, check out the [Konva.Group documentation](/api/Konva.Group.html). To apply opacity or a blend mode to a group as a whole, see [Isolated Groups](/docs/groups_and_layers/Isolated_Groups.html).
