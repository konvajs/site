...
slug: Opacity.html
description: "Learn how to set and change shape opacity (transparency) on HTML5 Canvas using Konva.js with values from 0 to 1."
---
...
To apply transparency to several shapes without seeing where they overlap, make their group isolated with `isolated: true`. See [Isolated Groups](/docs/groups_and_layers/Isolated_Groups.html) and the [Transparent Group demo](/docs/sandbox/Transparent_Group.html).
