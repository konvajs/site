...
description: "Learn how to constrain drag movement on HTML5 Canvas with Konva.js. Set drag boundaries to limit where shapes can be dragged."
---
...
**Instructions:** Drag and drop the horizontal text and observe that it can only
