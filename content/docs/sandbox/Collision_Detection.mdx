---
title: Canvas Collision Detection — Detect Shape Overlaps with JavaScript
sidebar_label: Collision Detection
hide_table_of_contents: true
slug: Collision_Detection.html
description: "Implement collision detection on HTML5 Canvas with JavaScript using Konva.js. Detect overlapping shapes with bounding box checks on draggable rectangles."
---
