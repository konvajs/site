---
title: Multi-touch Scale Shape Tutorial
sidebar_label: Multi-touch Scale Shape
hide_table_of_contents: true
slug: Multi-touch_Scale_Shape.html
description: "Scale individual Konva shapes with multi-touch pinch zoom gestures on mobile devices."
---
