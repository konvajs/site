---
title: Canvas Right-Click Context Menu — Custom Menu for Canvas Shapes
sidebar_label: Canvas Context Menu
hide_table_of_contents: true
slug: Canvas_Context_Menu.html
description: "Add a custom right-click context menu to HTML5 Canvas shapes with JavaScript using Konva.js. Includes pulse animation and delete actions on canvas objects."
---
