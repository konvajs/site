...
```html
<script src="https://unpkg.com/konva@3.4.0/konva.min.js"></script>
```

Or download from CDN:

* [Full version konva.js](https://unpkg.com/konva@3.4.0/konva.js)
* [Min version konva.min.js](https://unpkg.com/konva@3.4.0/konva.min.js)
