...
| `static/llms.txt` | Hand-curated English index. The Chinese index, `llms-full.txt`, `llms-small.txt`, and the `.md` page twins are generated post-build by `scripts/generate-llms.js` |
